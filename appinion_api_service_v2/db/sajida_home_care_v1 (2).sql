...
('SF1111', 'HC IT', '1990-01-01', 1, NULL, 0, 'badrujjaman@sajidafoundation.org', '', 2),
('SF_IT', 'SAJIDA IT Team', '1990-01-01', 1, NULL, 0, 'contact@sajidafoundation.org', '', 2);
...
(3, '2018-03-01 11:16:16', 0, 1, 'PT1808171', 'appinion');
...
(10, '2018-02-05', 1517803200000, 1517828400000, 7200000, 1517803815000, 1517811015000, 1.2, '\\\"this is not a feedback\\\"', 1, 0, '2018-02-05 04:32:14', 2, 'appinion', 1),
...
--
ALTER TABLE `tbl_caregiver_availability`
  MODIFY `caregiver_availability_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '1= Available, 0= Not Available', AUTO_INCREMENT=23;
...
--
ALTER TABLE `tbl_caregiver_schedule_feedback`
  MODIFY `tbl_caregiver_schedule_feedback_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tbl_preferable_caregiver_list`
  MODIFY `preferable_caregiver_list_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `tbl_promotional_item_request`
  MODIFY `promotional_item_request_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
